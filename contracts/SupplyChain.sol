...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  {
    require (items[_sku].seller != address(0) && items[_sku].state == State.ForSale, "Item must be ForSale");
    _;
  }
  ...
  {
    require (items[_sku].state == State.Shipped, "Item must be Sold");
    _;
  }
  modifier received (uint _sku)
  {
    require (items[_sku].state == State.Received, "Item must be Sold");
    _;
  }
